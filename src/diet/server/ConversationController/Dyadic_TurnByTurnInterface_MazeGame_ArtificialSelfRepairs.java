 ...
 * @author gj
 */
public class Dyadic_TurnByTurnInterface_MazeGame_ArtificialSelfRepairs extends MazeGameConversationControllerMultipleDyads {
    ...
    public Dyadic_TurnByTurnInterface_MazeGame_ArtificialSelfRepairs(Conversation c) {
        super(c);
