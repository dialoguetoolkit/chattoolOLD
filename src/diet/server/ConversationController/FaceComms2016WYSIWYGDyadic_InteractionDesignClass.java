 ...
 * @author gj
 */
public class FaceComms2016WYSIWYGDyadic_InteractionDesignClass  extends DefaultWYSIWYGConversationControllerInterface  implements JInterfaceMenuButtonsReceiverInterface {
   ...
   JInterfaceTenButtons jisp; 
    ...
    public FaceComms2016WYSIWYGDyadic_InteractionDesignClass(Conversation c) {
        super(c, 2, 3000);
