 ...
 * @author gj
 */
public class Dyadic_WYSIWYGInterface_ReferringToFaces  extends DefaultWYSIWYGConversationControllerInterface  implements JInterfaceMenuButtonsReceiverInterface {
   ...
   JInterfaceTenButtons jisp; 
    ...
    public Dyadic_WYSIWYGInterface_ReferringToFaces(Conversation c) {
        super(c, 2, 3000);
