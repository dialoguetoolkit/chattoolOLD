...
public class Dyadic_WYSIWYGInterface_Manipulation extends DefaultWYSIWYGConversationControllerInterface{
    ...
    public Dyadic_WYSIWYGInterface_Manipulation(Conversation c) {
          super(c,2,3000);
   ...
   public Dyadic_WYSIWYGInterface_Manipulation(Conversation c, int numberOfTracks, int durationOfTimeout) {
        super(c,2,3000);
    ...
    /// All the m
     ...
     public void sendWYSIWYGTextToClient(Participant recipient, int wysiwygWindownumber, String textToBeAppended, MutableAttributeSet mas, String originUsername){
      ...
      public void changeClientInterfaceCharacterWhitelist(Participant recipient, String whitelist){
         ...
         MessageChangeClientInterfaceProperties mccip= new MessageChangeClientInterfaceProperties(c.generateNextIDForClientDisplayConfirm(),ClientInterfaceEventTracker.setCharWhitelist, whitelist);
         c.getParticipants().sendMessageToParticipant(recipient, mccip);    
