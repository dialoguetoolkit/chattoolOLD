 ...
 * @author gj
 */
public class Triadic_TurnByTurnInterface_ReferringToFaces_ArtificialTurnDelayOfOneParticipant extends Triadic_TurnByTurnInterface_ReferringToFaces{
    ...
    public Triadic_TurnByTurnInterface_ReferringToFaces_ArtificialTurnDelayOfOneParticipant(Conversation c) {
        super(c);
