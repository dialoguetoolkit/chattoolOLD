 ...
 * @author gj
 */
public class Dyadic_TurnByTurnInterface_ReferringToFaces extends Dyadic_TurnByTurnInterface{
    ...
    public Dyadic_TurnByTurnInterface_ReferringToFaces(Conversation c) {
        super(c);
