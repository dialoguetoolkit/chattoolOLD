 ...
 * @author gj
 */
public class Dyadic_TurnByTurnInterface_MazeGame extends MazeGameConversationControllerMultipleDyads {
    ...
    public Dyadic_TurnByTurnInterface_MazeGame(Conversation c) {
        super(c);
