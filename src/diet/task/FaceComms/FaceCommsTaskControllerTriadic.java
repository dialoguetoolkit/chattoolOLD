     ...
     private void loadNextFaceSet2PlusOne(Participant pSharing1, Participant pSharing2, Participant pNotsharing){
           ...
           if(pA==pSharing1){
                 this.pA_Imagename=    "faceset4and5/"  + imageName1 +".png";   
                  ...
                  this.pA_Imagename= "faceset4and5/"  + imageName2 +".png";
           }
           else if(pA==pNotsharing){
                  this.pA_Imagename= "faceset4and5/" + imageName3 + ".png";
           }
           
           if(pB==pSharing1){
                  this.pB_Imagename=    "faceset4and5/"  + imageName1 +".png";  
           }
           else if (pB==pSharing2){
                  this.pB_Imagename= "faceset4and5/"  + imageName2 +".png";
           }
           else if(pB==pNotsharing){
                  this.pB_Imagename= "faceset4and5/" + imageName3 + ".png";
           }
           
           if(pC==pSharing1){
                  this.pC_Imagename=    "faceset4and5/"  + imageName1 +".png";  
           }
           else if (pC==pSharing2){
                  this.pC_Imagename= "faceset4and5/"  + imageName2 +".png";
           }
