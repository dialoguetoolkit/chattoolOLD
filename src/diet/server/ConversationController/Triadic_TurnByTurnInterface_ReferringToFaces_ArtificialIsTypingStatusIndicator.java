 ...
 * @author gj
 */
public class Triadic_TurnByTurnInterface_ReferringToFaces_ArtificialIsTypingStatusIndicator extends Triadic_TurnByTurnInterface_ReferringToFaces{
    ...
    public Triadic_TurnByTurnInterface_ReferringToFaces_ArtificialIsTypingStatusIndicator(Conversation c) {
        super(c);
