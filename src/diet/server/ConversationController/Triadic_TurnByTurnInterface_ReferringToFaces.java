 ...
 * @author gj
 */
public class Triadic_TurnByTurnInterface_ReferringToFaces extends DefaultConversationController{
    ...
    public Triadic_TurnByTurnInterface_ReferringToFaces(Conversation c) {
        super(c);
