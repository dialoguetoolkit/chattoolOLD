 ...
 * @author gj
 */
public class Dyadic_SplitScreenInterface_MazeGame extends MazeGameConversationControllerMultipleDyads{

    boolean evenMazesAreSplitScreen = true;
    
    
    public Dyadic_SplitScreenInterface_MazeGame(Conversation c) {
        super(c);
