 ...
 * @author gj
 */
public class ProcCommsWYSIWYG extends DefaultWYSIWYGConversationControllerInterface implements JInterfaceMenuButtonsReceiverInterface{
   ...
   boolean useNormalInterface = true;//CustomDialog.getBoolean("use normal interface?", "normal", "wysiwyg");
    ...
    public ProcCommsWYSIWYG(Conversation c) {
        super(c, 2, 2500);
