...
public class Dyadic_TurnByTurnInterface_ArtificialIsTypingStatusIndicator extends Dyadic_TurnByTurnInterface{
    ...
    public Dyadic_TurnByTurnInterface_ArtificialIsTypingStatusIndicator(Conversation c) {
        super(c);
